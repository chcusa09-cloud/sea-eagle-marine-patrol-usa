...
for (const name of ['sea-eagle-logo.jpeg', 'maritime-hero.webp', 'viking-hero.webp', 'social-facebook.svg', 'social-tiktok.svg', 'social-instagram.svg']) await copyFile(`public/${name}`, `pages-dist/${name}`);
function url(path) {
