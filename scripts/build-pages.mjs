...
for (const name of ['sea-eagle-logo.jpeg', 'maritime-hero.webp', 'viking-hero.webp', 'gulf-houston-food-bank.webp', 'atlanta-charity-outreach.webp', 'atlanta-leadership-summit.webp', 'foundation-donation.webp', 'social-facebook.svg', 'social-tiktok.svg', 'social-instagram.svg']) await copyFile(`public/${name}`, `pages-dist/${name}`);
function url(path) {
